...
class WooCommerce_Bulk_Order_Form_Settings_Framework {
	...
	function admin_menu() {
		$this->page_hook = add_submenu_page( 'woocommerce', __( 'Bulk Order Form Settings', WC_BOF_TXT ), __( 'Bulk Order Form Settings', WC_BOF_TXT ), 'manage_woocommerce', WC_BOF_SLUG . '-settings', array(
			$this,
			'admin_page',
		) );
	}
	...
	public function admin_page() {
		echo '<div class="wrap wc_bof_settings">';
		echo '<h2>' . WC_BOF_NAME . ' Settings</h2>';

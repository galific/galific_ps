...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'galific', 'user' => 'ps_galific', 'password' => 'galific@2019', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8LcRikEbb8hQATE3AvzaoJTPMFpHppsQ7kS5E6YyLZa6SFSFQOj0gyBG')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8LcRikEbb8hQATE3AvzaoJTPMFpHppsQ7kS5E6YyLZa6SFSFQOj0gyBG');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                63 => 'posstaticfooter',
                64 => 'postabcateslider',
                65 => 'poslistcategories',
                66 => 'possearchproducts',
                67 => 'posrecommendedproducts',
                68 => 'poscountdown',
                69 => 'posproductsmanufacturer',
                70 => 'poslistcateproduct',
                71 => 'citruspayu',
                72 => 'paytm',
                73 => 'apimodule',
                74 => 'dateofdelivery',
                75 => 'webmastersiteverification',
                76 => 'posspecialproducts',
                77 => 'ps_advertising',
            ...
            'database_port' => '',
            'database_name' => 'galific',
            'database_user' => 'ps_galific',
            'database_password' => 'galific@2019',
            'database_prefix' => 'ps_',
            ...
            'secret' => '8LcRikEbb8hQATE3AvzaoJTPMFpHppsQ7kS5E6YyLZa6SFSFQOj0gyBG',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-01-17',
            'locale' => 'en-US',
            'cookie_key' => 'NeCq62ICVw7Qh8kGar79zu083HMBFCIK5P3w6q0L5Ph7foctxcnvK4zP',
            'cookie_iv' => 'P4nvcApe',
            'new_cookie_key' => 'def00000e04b9c3ca97564791ec5cd3a174fe40388acb2213d24d477c768533144d466c25bc1aa0a78a62f77df4dcd8834948dd0794c33be52cc9a00606bf39d0172515a',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '8LcRikEbb8hQATE3AvzaoJTPMFpHppsQ7kS5E6YyLZa6SFSFQOj0gyBG',

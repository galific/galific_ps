...
, please contact our support to: contact@sendinblue.com');
    ...
    private function displayForm()
    {
        ...
        ' . $this->l('Create your free SendinBlue : ') . '<a href="' . $this->l('https://www.sendinblue.com?utm_source=prestashop_plugin&utm_medium=plugin&utm_campaign=module_link') . '" class="link_action" style="color:#268CCD;"  target="_blank">&nbsp;' . $this->l('https://www.sendinblue.com') . '</a></div><br />';

...
class JmFacetedsearchProductSearchProvider implements ProductSearchProviderInterface
{
    private $module;
    ...
    private function copyFiltersActiveState(array $sourceFacets, array $targetFacets)
    {

...
<div id="checkout-review-table-wrapper">
                ...
                {*<tr class="jm-item">*}
                    {*<td class="jm-item-img">*}
                        {*<div class="jm-item-img-inner">*}
                            ...
                            {*<img src='{$link->getImageLink($product.link_rewrite, $product.id_image)|escape:"html":"UTF-8"}' alt=""/>*}
                        {*</div>*}
                    {*</td>*}
    ...
    <div id="checkout-review-submit">
        {*{if $conditions && $cms_id}*}
            <form action="" id="checkout-agreements" class="checkout-agreements" onsubmit="return false;">
                <dl class="sp-methods">
                    <dt>
                        <input type="checkbox" id="agreement-1" name="agreement[1]" value="1" title="Terms &amp; Conditions" class="checkbox" checked="checked">
                    ...
                    <ul class="form-list" id="coupon-content" aria-expanded="false" style="height: auto;">
                            ...
                            {*{if sizeof($discounts)}*}
                                {*<table>*}
                                    ...
                                    {*{foreach $discounts as $discount}*}
                                        ...
                                        {*{/if}*}
                                        {*<tr>*}
                                            {*<td style="" class="a-right">{$discount.name}</td>*}
                                            {*<td style="" class="a-right" colspan="2">*}
                                                {*{if strlen($discount.code)}*}
                                                    {*<i class="icon-trash" onclick="coupon.remove('{$discount.id_discount}')"></i>*}
                                                {*{/if}*}
                                            {*</td>*}
                                        {*</tr>*}
                                    {*{/foreach}*}
                        ...
                        <li>
                            ...
                            <div class="buttons-set">
                                <button type="button" class="ladda-button" data-color="jmango" data-size="xs" data-style="slide-up" onclick="" style="width:auto;" id="coupon-button" title="Apply Coupon" value="Apply Coupon">
    ...
    <div class="buttons-set" id="review-buttons-container">
        <button type="button" id="review-button" class="ladda-button" data-color="jmango" data-style="slide-up" onclick="" data-size="s">

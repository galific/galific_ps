...
<div class="delivery-options-list">
        ...
        >
            <div class="form-fields">
                ...
                <div class="order-options">
                    <div id="delivery">
                        <label for="delivery_message">{l s='If you would like to add a comment about your order, please write it in the field below.' d=$module_name}</label>
                ...
                <label for="input_recyclable">{l s='I would like to receive my order in recycled packaging.' d=$module_name}</label>
              </span>
                    {/if}
    ...
    {else}
        <p class="alert alert-danger">{l s='Unfortunately, there are no carriers available for your delivery address.' d=$module_name}</p>
    {/if}
</div>

...
<div id="order-items" class="col-md-12">
    ...
    {block name='order_items_table_head'}
        <h3 class="card-title h3">{l s='Order items' d=$module_name}</h3>
    {/block}
        ...
        {block name='order_confirmation_table'}
                            ...
                            {foreach from=$product.customizations item="customization"}
                                <div class="customizations">
                                    <a href="#" data-toggle="modal"
                                       data-target="#product-customizations-modal-{$customization.id_customization}">{l s='Product customization' d=$module_name}</a>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">{l s='Product customization'  d=$module_name}</h4>
                                            </div>
            ...
            <table>
                ...
                <tr class="font-weight-bold">
                    <td>
                        <span class="text-uppercase">{$totals.total.label}</span> {$labels.tax_short}
                    </td>

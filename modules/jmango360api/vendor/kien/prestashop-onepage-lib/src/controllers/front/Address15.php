...
class Address15 extends AddressController
{
    ...
    public function initContent()
    {
        ...
        if ($this->context->getMobileDevice()) {
            $this->setMobileTemplate(_PS_MODULE_DIR_ . $this->module_name .'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/address15-mobile.tpl');
        } else {
            $this->setTemplate(_PS_MODULE_DIR_ . $this->module_name .'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/address15.tpl');
        }
    }

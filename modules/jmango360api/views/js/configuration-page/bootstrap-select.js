...
(function($) {
  ...
  Selectpicker.prototype = {
    ...
    render: function(updateLi) {
      ...
      var notDisabled = this.options.hideDisabled ? ':enabled' : '',
          selectedItems = this.$element.find('option:selected' + notDisabled).map(function() {
			...
			if ($this.attr('data-thumbnail')) {
              iconImage = '<img src="'+ $this.attr('data-thumbnail') +'" />';
		  ...
		  selectedItemsImage = this.$element.find('option:selected' + notDisabled).map(function() {
            var $this = $(this);
	  ...
	  var selectedItemsImage = selectedItemsImage[0];
	  
	  // console.log(selectedItemsImage);
	  ...
	  // this.$button.children('.filter-option').html(selectedItemsImage);
      this.$button.children('.filter-option').html((!this.multiple || this.options.selectedTextFormat==='values') ? title : this.options.title);
	  this.$button.children('.filter-option').prepend(selectedItemsImage);

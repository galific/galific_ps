 ...
 *}
<div id="pretashop-qs-login" class="login-screen">
        ...
        <div class="login-box-wrap">
            <div class="login-box">
                ...
                <form id="login-form" class="login-form">
                    <div id="ps-change-password" style="display: none" class="message-login">Seems like you changed your password on JMango360 please login again</div>
                    <div class="fields">
                        <div id="login-error-message" class="form-field error-field"></div>
                        <div class="form-field">
                            <div class="label-field" id="txt_login_email_address">Email Address *</div>
                            <div class="input-field">
                                <input type="text" id="ps-login-username" class="txt-input" placeholder="example@email.com" autofocus />
                            </div>
                        </div>
                        <div class="form-field">
                            <div class="label-field" id="txt_login_password">Password *</div>
                            <div class="input-field">
                                <input type="password" id="ps-login-password" class="txt-input" placeholder="Examplepassword" />
                            ...
                            <a class="forget-pwd" href="#" id="txt_login_forgot_password">Forgot password</a>
                        </div>
                        <div class="form-field submit-field">
                            <div class="input-field">
                                <button id="pres-qs-btnLoginSubmit" class="btnSubmit" type="button"><span class="text" id="txt_login_btn_login">Login</span></button>
                            </div>
                        </div>

...
class Posslideshows extends Module implements WidgetInterface
{
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
		...
		foreach($slides as &$slide){
			...
			$slide['description'] = str_replace('/pos_juvento/',__PS_BASE_URI__,$slide['description']);
		}
        if (is_array($slides)) {
            foreach ($slides as &$slide) {
    ...
    public function getAddFieldsValues()
    {
        ...
        $languages = Language::getLanguages(false);
		 ...
		 foreach ($languages as $lang) {
			...
			$fields['description'][$lang['id_lang']] = str_replace('/pos_juvento/',__PS_BASE_URI__,$fields['description'][$lang['id_lang']]);
		}

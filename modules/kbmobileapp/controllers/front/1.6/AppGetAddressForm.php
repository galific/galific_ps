...
class AppGetAddressForm extends AppCore
{
    ...
    public function getFormData()
    {
        ...
        /*start:changes made by aayushi on 7 march 2019 to send unique data*/
        //return $form_data;
        ...
        /*end:changes made by aayushi on 7 march 2019 to send unique data*/
    }
    ...
    public function assignCountriesList()
    {
        ...
        foreach ($countries as $country) {
            $country_list[$country_index] = array(
                 ...
                 * to resolve the issue of incorrect country name due to htmlentity encoding
                 * As initially we were encoding country name
                 */
                'name' => $country['name']
                /* Changes over */
            );

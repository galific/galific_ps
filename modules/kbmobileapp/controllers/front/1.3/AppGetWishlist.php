            ...
            if ($wishlist_products) {
                ...
                foreach ($wishlist_products as $product) {
                    ...
                    if ($priceDisplay >= 0 && $priceDisplay <= 2) {
                        if ($price_without_reduction <= 0 || (isset($product_obj->specificPrice) && !$product_obj->specificPrice)) {
                            ...
                            if (isset($product_obj->specificPrice) && $product_obj->specificPrice) {
                            ...
                            } elseif (isset($product_obj->specificPrice) && $product_obj->specificPrice

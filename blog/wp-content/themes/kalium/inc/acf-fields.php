...
if ( function_exists( 'register_field_group' ) ) {
	register_field_group( array(
		...
		'fields'     => array(
			array(
				'key'   => 'field_5a69e31fc7c97',
				'label' => 'Menu Settings',
				'name'  => '',
				'type'  => 'tab',
			),
			array(
				'key'          => 'field_5a69e332c7c98',
				'label'        => 'Menu',
				'name'         => 'sm_menu_id',
				'type'         => 'nav_menu',
				'instructions' => 'Select navigation menu to show.',
				'save_format'  => 'id',
				'container'    => 'div',
				'allow_null'   => 1,
			),
			array(
				'key'           => 'field_5a69f9419589f',
				'label'         => 'Dropdown Caret',
				'name'          => 'sm_submenus_caret',
				'type'          => 'true_false',
				'instructions'  => 'Show dropdown caret next to menu items that have submenus.',
				'message'       => '',
				'default_value' => 0,
			),
			array(
				'key'   => 'field_5a69e3a19f582',
				'label' => 'Layout Settings',
				'name'  => '',
				'type'  => 'tab',
			),
			array(
				'key'           => 'field_5a69e3b09f583',
				'label'         => 'Alignment',
				'name'          => 'sm_alignment',
				'type'          => 'select',
				'instructions'  => 'Side menu alignment on browser viewport.',
				'choices'       => array(
					'left'  => 'Left',
					'right' => 'Right',
				),
			...
			array(
				'key'   => 'field_5a6b2109d417b',
				'label' => 'Animation',
				'name'  => '',
				'type'  => 'tab',
			),
			array(
				'key'           => 'field_5a6b2130d417c',
				'label'         => 'Side Menu',
				'name'          => 'sm_animation_type_content',
				'type'          => 'select',
				'instructions'  => 'Select animation type when side menu toggles on screen.',
				'choices'       => array(
					'none'  => 'None',
					'slide' => 'Slide',
				),
